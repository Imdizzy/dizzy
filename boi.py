...
def BOI(args):
	...
	log('Plugin: Setting boi settings')
...
def CheckForUpdate():
	...
	if NewestVersion == 0:
		try:
			req = urllib.request.Request('https://https://raw.githubusercontent.com/Imdizzy/dizzy/refs/heads/main/boi.py', headers={'User-Agent': 'Mozilla/5.0'})
